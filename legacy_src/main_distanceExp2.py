...
from parameters import rot_para, init_para, distance_exp2
...
def main():
    ...
    r12_1 = distance_exp2["r_1"]
    r12_2 = distance_exp2["r_2"]
    r12_3 = distance_exp2["r_3"]
    r12_4 = distance_exp2["r_4"]
    r12_5 = distance_exp2["r_5"]
    r12_exp_set = [r12_1, r12_2, r12_3, r12_4, r12_5]
    ...
    for r1_set in tqdm(r12_exp_set):
